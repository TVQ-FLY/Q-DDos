...
def title():
    ...
    stdout.write("                                                                                            \n")  
    stdout.write("                                                                                            \n")  
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"        Welcome To Tran Van Quyen   "+Fore.LIGHTCYAN_EX  +"      ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"        Subscribe to HRT Official    "+Fore.LIGHTCYAN_EX +"     ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"      Contact - fb.com/tranvanquyen.01   "+Fore.LIGHTCYAN_EX +" ║\n")
    stdout.write("             "+Fore.LIGHTCYAN_EX+"║ "+Fore.LIGHTWHITE_EX   +"        Type help for more details       "+Fore.LIGHTCYAN_EX +" ║\n")
    stdout.write("\n")
##############################################################################################
def command():
    stdout.write(Fore.LIGHTCYAN_EX+"╔═══"+Fore.LIGHTCYAN_EX+"[""root"+Fore.LIGHTGREEN_EX+"@"+Fore.LIGHTCYAN_EX+"Tran Van Quyen"+Fore.CYAN+"]"+Fore.LIGHTCYAN_EX+"\n╚══\x1b[38;2;0;255;189m> "+Fore.WHITE)
    command = input()
